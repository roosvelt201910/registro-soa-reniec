        ...
        <div class="main-content">
            ...
            <footer class="footer">
                ...
                <div class="footer-bottom">
                    <p>&copy; 2025 Sistema Académico - Registro Auxiliar Docente.|Desarrollado por Estudiantes de Grupo 5 - Curso Arquitectura Orientado al Servicio - UTP| Todos los derechos reservados.</p>
                </div>
            </footer>
        </div>
    </div>
