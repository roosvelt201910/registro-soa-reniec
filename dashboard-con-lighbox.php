...
<body>
    ...
    <div class="lightbox-container" id="lightboxContainer">
        <div class="lightbox-content">
            <div class="lightbox-header">
                <h3 class="lightbox-title" id="lightboxTitle">
            ...
            <div class="sidebar-nav">
                <?php if ($user_type == 'super_admin'): ?>
                    <div class="nav-section">
                        ...
                        <a href="#" class="nav-item modal-link" data-url="admin/manage_users.php" data-title="Gestionar Usuarios">
                            <i class="fas fa-users-cog"></i>
                            <span>Gestionar Usuarios</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="admin/manage_courses.php" data-title="Gestionar Cursos">
                            <i class="fas fa-book-open"></i>
                            <span>Gestionar Cursos</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="admin/manage_programs.php" data-title="Programas de Estudio">
                            <i class="fas fa-graduation-cap"></i>
                            <span>Programas de Estudio</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="admin/reports.php" data-title="Reportes Generales">
                    ...
                    <div class="nav-section">
                        ...
                        <a href="#" class="nav-item modal-link" data-url="admin/system_settings.php" data-title="Configuración">
                            <i class="fas fa-cogs"></i>
                            <span>Configuración</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="admin/backup.php" data-title="Respaldos">
                            <i class="fas fa-database"></i>
                            <span>Respaldos</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="admin/profile.php" data-title="Perfil">
                ...
                <?php elseif ($user_type == 'docente'): ?>
                    <div class="nav-section">
                        ...
                        <a href="#" class="nav-item modal-link" data-url="teacher/my_courses.php" data-title="Mis Unidades Didácticas">
                            <i class="fas fa-book-open"></i>
                            <span>Mis Unidades Didácticas</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="teacher/attendance.php" data-title="Registro de Asistencia">
                            <i class="fas fa-user-check"></i>
                            <span>Registro de Asistencia</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="teacher/evaluations.php" data-title="Evaluaciones">
                            <i class="fas fa-clipboard-list"></i>
                            <span>Evaluaciones</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="teacher/reports.php" data-title="Reportes y Consolidados">
                    ...
                    <div class="nav-section">
                        ...
                        <a href="#" class="nav-item modal-link" data-url="teacher/manage_students.php" data-title="Gestionar Estudiantes">
                            <i class="fas fa-users"></i>
                            <span>Gestionar Estudiantes</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="teacher/sessions.php" data-title="Programar Sesiones">
                            <i class="fas fa-calendar-plus"></i>
                            <span>Programar Sesiones</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="teacher/profile.php" data-title="Mi Perfil">
                ...
                <?php else: // estudiante ?>
                    <div class="nav-section">
                        ...
                        <a href="#" class="nav-item modal-link" data-url="student/my_courses.php" data-title="Mis Cursos">
                            <i class="fas fa-book"></i>
                            <span>Mis Cursos</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="student/grades.php" data-title="Mis Notas">
                            <i class="fas fa-chart-line"></i>
                            <span>Mis Notas</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="student/attendance.php" data-title="Mi Asistencia">
                            <i class="fas fa-calendar-check"></i>
                            <span>Mi Asistencia</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="student/reports.php" data-title="Mis Reportes">
                    ...
                    <div class="nav-section">
                        ...
                        <a href="#" class="nav-item modal-link" data-url="student/schedule.php" data-title="Mi Horario">
                            <i class="fas fa-calendar-alt"></i>
                            <span>Mi Horario</span>
                        </a>
                        <a href="#" class="nav-item modal-link" data-url="student/profile.php" data-title="Mi Perfil">
                            <i class="fas fa-user-circle"></i>
                            <span>Mi Perfil</span>
                        </a>
                    </div>
                    ...
                    <div class="welcome-content">
                        ...
                        <div class="quick-actions">
                            <?php if ($user_type == 'docente'): ?>
                                <a href="#" class="quick-action-btn modal-link" data-url="teacher/evaluations.php" data-title="Evaluaciones">
                                    <i class="fas fa-clipboard-list"></i>
                                    Evaluaciones
                                </a>
                                <a href="#" class="quick-action-btn modal-link" data-url="teacher/attendance.php" data-title="Asistencia">
                                    <i class="fas fa-user-check"></i>
                                    Asistencia
                                </a>
                            <?php elseif ($user_type == 'estudiante'): ?>
                                <a href="#" class="quick-action-btn modal-link" data-url="student/grades.php" data-title="Mis Notas">
                                    <i class="fas fa-chart-line"></i>
                                    Mis Notas
                                </a>
                                <a href="#" class="quick-action-btn modal-link" data-url="student/attendance.php" data-title="Mi Asistencia">
                                    <i class="fas fa-calendar-check"></i>
                                    Mi Asistencia
                                </a>
                            <?php else: ?>
                                <a href="#" class="quick-action-btn modal-link" data-url="admin/manage_users.php" data-title="Gestionar Usuarios">
                                    <i class="fas fa-users-cog"></i>
                                    Gestionar Usuarios
                                </a>
                                <a href="#" class="quick-action-btn modal-link" data-url="admin/reports.php" data-title="Reportes">
                                    <i class="fas fa-chart-bar"></i>
                                    Reportes
                                </a>
                            <?php endif; ?>
                                ...
                                foreach ($displayCourses as $course): ?>
                                    <li class="course-item">
                                        ...
                                        <div class="course-actions">
                                            <?php if ($user_type == 'docente'): ?>
                                                <a href="#" class="btn-small btn-primary modal-link" data-url="teacher/evaluations.php?course_id=<?php echo $course['id']; ?>" data-title="Evaluar">
                                                    <i class="fas fa-clipboard-list"></i> Evaluar
                                                </a>
                                                <a href="#" class="btn-small btn-outline modal-link" data-url="teacher/attendance.php?course_id=<?php echo $course['id']; ?>" data-title="Asistencia">
                                                    <i class="fas fa-user-check"></i> Asistencia
                                                </a>
                                            <?php elseif ($user_type == 'estudiante'): ?>
                                                <a href="#" class="btn-small btn-primary modal-link" data-url="student/grades.php?course_id=<?php echo $course['id']; ?>" data-title="Ver Notas">
                    ...
                    <div>
                        ...
                        <?php if ($user_type == 'docente' && isset($stats['evaluaciones_pendientes']) && $stats['evaluaciones_pendientes'] > 0): ?>
                            <div class="notification-panel">
                                ...
                                <a href="#" class="quick-action-btn modal-link" data-url="teacher/evaluations.php" data-title="Evaluaciones" style="background: rgba(255,255,255,0.2); margin-top: 1rem;">
            ...
            <footer class="footer">
                <div class="footer-content">
                    <div class="footer-section">
                        <h3><i class="fas fa-graduation-cap"></i> Sistema Académico</h3>
                        <p>Plataforma educativa diseñada para facilitar la gestión académica de docentes y estudiantes, optimizando los procesos de enseñanza y aprendizaje.</p>
                    ...
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="#"><i class="fas fa-chevron-right"></i> Acerca del Sistema</a></li>
                            <li><a href="#"><i class="fas fa-chevron-right"></i> Preguntas Frecuentes</a></li>
                            <li><a href="#"><i class="fas fa-chevron-right"></i> Políticas de Uso</a></li>
                    ...
                    <div class="footer-section">
                        ...
                        <ul class="contact-info">
                            <li>
                                ...
                                <span>Carretera Fernando Belaunde Terry Km. 4.8 Sector Pucayacu - Tocache, San Martin, Perú</span>
                            </li>
                            <li>
                                <i class="fas fa-phone"></i>
                                <span>+51 950 980 740</span>
                            </li>
                            <li>
                                <i class="fas fa-envelope"></i>
                                <span>soporte@iespaltohuallaga.edu.pe</span>
                            </li>
                            <li>
                                <i class="fas fa-clock"></i>
                                <span>Lun - Vie: 7:30 AM - 3:00 PM</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="footer-bottom">
                    <p>&copy; 2025 Sistema Académico - Registro Auxiliar Docente. | Desarrollado por Roosvelt Enriquez Gamez | Todos los derechos reservados.</p>
                </div>
            </footer>
        </div>
    </div>
    ...
    <div class="whatsapp-button">
        ...
        <a href="https://wa.me/51950980740?text=Hola,%20me%20gustaría%20obtener%20más%20información" target="_blank" rel="noopener noreferrer" class="whatsapp-link" aria-label="Contactar por WhatsApp">
    ...
    <script>
        ...
        function openLightbox(url, title) {
            // Actualizar título
            lightboxTitle.innerHTML = `<i class="fas fa-window-restore"></i> ${title}`;
            ...
            fetch(url)
                ...
                .then(html => {
                    ...
                    const scripts = lightboxBody.querySelectorAll('script');
                    ...
                    lightboxBody.innerHTML = `
                        <div class="empty-state">
                            ...
                            <p style="margin-top: 1rem;">
                                <button onclick="closeLightbox()" class="quick-action-btn">
        ...
        // Event delegation para los enlaces del menú
        document.addEventListener('click', (e) => {
            const modalLink = e.target.closest('.modal-link');
            if (modalLink) {
                e.preventDefault();
                const url = modalLink.getAttribute('data-url');
                const title = modalLink.getAttribute('data-title') || 'Contenido';
                openLightbox(url, title);
            }
        });
        
        // Animaciones y efectos del dashboard
